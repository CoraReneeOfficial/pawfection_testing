"""
Fix duplicate superadmin_system_logs function names in app.py by renaming the second occurrence.
"""
import re
...
def fix_duplicate_function():
    try:
        ...
        matches = list(re.finditer(r'def superadmin_system_logs\(\):', content))
        ...
        new_content = (
            ...
            content[start_pos + len("def superadmin_system_logs():"):]
        )
        
        # Also change the route path for the second occurrence
        route_pattern = r"@app\.route\('/superadmin/system-logs'\)"
        ...
        if len(route_matches) >= 2:
            ...
            new_content = (
                ...
                "@app.route('/superadmin/system-logs-alt')" + 
